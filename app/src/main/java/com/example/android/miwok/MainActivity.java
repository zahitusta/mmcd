...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        family.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                // Create a new intent to open the {@link myFavoritesActivity}
                Intent familyIntent = new Intent(MainActivity.this, myFavoritesActivity.class);
        ...
        playList.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                // Create a new intent to open the {@link PlayMusicActivity}
                Intent playListIntent = new Intent(MainActivity.this, PlayMusicActivity.class);
